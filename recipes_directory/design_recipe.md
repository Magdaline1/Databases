...
```bash
psql -h 127.0.0.1 database_name < database_table.sql
```
...
INSERT INTO recipes (names, cooking_time, rating) VALUES ('Carbonara', 25, 3);
INSERT INTO recipes (names, cooking_time, rating) VALUES ('Bolognese', 45, 4);
```
...
recipes.length # => 2
recipes.first.id # => '1'
recipes.first.name # => 'Carbonara'
recipes.first.cooking_time # => 25
recipes.first.rating # => 3
